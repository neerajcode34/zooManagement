...
<html>
<head>
<title>WildGuard: Nurturing Nature | Home Page</title>
				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>Tiger</h4>
							<p>Like the human fingerprint, each tiger’s stripe pattern is one of a kind. Individual tigers are identified by their unique stripes</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>Elephant</h4>
							<p>There are three species of elephant: African Savanna (Bush), African Forest and Asian. The ears of African elephants are much larger than their cousins and are described as being shaped like the African continent, whereas the ears of Asian elephants are shaped like the Indian subcontinent.</p>
						</div>
